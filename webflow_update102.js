...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  function populateNoResults() {
    ...
    cardContainer.innerHTML = `<div r-filter-empty="1" data-w-id="80db50af-0de9-1d98-45fe-5f2fe7dc5208" style="opacity: 1; display: block;" class="c-filter_empty"><div class="c-empty-content"><div class="c-emoji"><img src="https://assets-global.website-files.com/6594b42fafa3f5020fd68380/664d71ef26c4c28269f5f8a4_Video.GIF" loading="lazy" alt="" class="c-emoji-image"></div><div class="c-title-wrapper cc-margin"><p class="c-title-1 cc-center">FINDING&nbsp;YOUR&nbsp;FUNNY</p></div><div class="c-paragraph-wrapper"><p class="c-title-3 cc-gray500 cc-center">Patience was never your strong suit, was it?</p></div></div></div>`;
  }
    ...
    searchBar.addEventListener("input", async (event) => {
      ...
      if (searchBarActive) {
        ...
        if (q === "") {
          ...
          const comedianSearch = await comedianIndex.search(q, {attributesToSearchOn: ['name']});
          const venueSearch = await venueIndex.search(q, {attributesToSearchOn: ['venue_name']});
